# David · Software Engineer & Product Builder

### Convierto problemas reales en software que se puede usar, operar y hacer crecer.

Trabajo en la intersección entre producto e ingeniería: entiendo la operación, ordeno la complejidad y construyo sistemas que sobreviven al caso difícil. En **Tecnológica-AletheIA** he participado de punta a punta en productos para facturación, pagos, reservas, inventario, educación, salud y gestión de negocios.

No me interesa escribir código por escribir código. Me interesa que una persona pueda completar su trabajo sin pelearse con el sistema.
...
## Proyectos que resumen mi experiencia
...
- Me gusta dejar cada cambio más entendible que como lo encontré.
...
Construyendo software de negocio con foco en **claridad de producto, integraciones confiables y operaciones que no se rompen cuando aparece el caso que nadie había previsto**.

<p align="center">
  <em>Software útil primero. Ingeniería con intención siempre.</em>
</p>
